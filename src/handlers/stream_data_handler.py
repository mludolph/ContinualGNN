...
class StreamDataHandler(DataHandler):
    ...
    def load(self, data_name, t):
        ...
        self.train_cha_nodes_list, self.train_old_nodes_list = list(
            self.train_cha_nodes_list
        ), list(self.train_old_nodes_list)
        self.valid_cha_nodes_list, self.valid_old_nodes_list = list(
            self.valid_cha_nodes_list
        ), list(self.valid_old_nodes_list)
